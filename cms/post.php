...
if(isset($_GET['p_id'])){ //get request coming from index.php
          ...
          //this is to get 1 views in every visit of the post title on post.php increment lecture 213
         $view_counts = "UPDATE posts set post_views_counts = post_views_counts + 1 WHERE post_id = $the_post_id";
         $send_counts = mysqli_query($connection,$view_counts);
         //lecture 213 increment by 1
      ...
      while($row = mysqli_fetch_assoc($select_all_posts)){
         ...
         $post_content = substr($row['post_content'],0,100);//substring means 100 characters ma show  
            ...
            ?>
                ...
                <?php } 
                 }else{ //if walay post_id..? mo redirect ka sa index.php
            ...
            redirect(Location:"/cms2022/post.php?p_id=$the_post_id ");
                    } //end og post request
